...
from L90_form_control_description import C90_FormControlDescription
from L90_form_control_destination import C90_FormControlDestination
...
class C40_Application(C20_PySideApplication):
	...
	def Init_10(self):
		...
		self.form_control_description = C90_FormControlDescription(self)
		self.form_control_destination = C90_FormControlDestination(self)
