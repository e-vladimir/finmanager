...
class C40_Workspace(C30_StructFrame):
	...
	def InitFields(self):
		...
		self.f_record_findata_oid    = C30_StructField(self, "Запись финданных")
		self.f_record_finactions_oid = C30_StructField(self, "Запись финдействий")
		self.f_record_rules_oid      = C30_StructField(self, "Запись правил")
