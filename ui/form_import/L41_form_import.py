...
class C41_FormImport(C20_PySideForm, Ui_frm_import):
	...
	def InitMenuOperation(self):
		...
		self.submenu_operations                      = self.menu_operations.addMenu(icon_list, "Финансовые операции")
		self.action_operations_open_file   : QAction = self.submenu_operations.addAction(icon_open,   "Открыть файл")
		self.action_operations_switch_data : QAction = self.submenu_operations.addAction(icon_reload, "Сменить набор данных")
