...
class Ui_frm_accounts(object):
    def setupUi(self, frm_accounts):
        if not frm_accounts.objectName():
            frm_accounts.setObjectName(u"frm_accounts")
        frm_accounts.resize(800, 640)
        self.centralwidget = QWidget(frm_accounts)
        ...
        frm_accounts.setCentralWidget(self.centralwidget)
        self.statusbar = QStatusBar(frm_accounts)
        self.statusbar.setObjectName(u"statusbar")
        frm_accounts.setStatusBar(self.statusbar)

        self.retranslateUi(frm_accounts)

        QMetaObject.connectSlotsByName(frm_accounts)
    # setupUi

    def retranslateUi(self, frm_accounts):
        frm_accounts.setWindowTitle(QCoreApplication.translate("frm_accounts", u"MainWindow", None))
    # retranslateUi
