...
class C41_FormAccounts(C20_PySideForm, Ui_frm_accounts):
	...
	def Init_MenuAccounts(self):
		...
		self.menu_accounts_struct_transfer_prev_dm : QAction = self.menu_accounts_struct.addAction(icon_arrow_l,     "Перенести в прошлый месяц")
		self.menu_accounts_struct_transfer_next_dm : QAction = self.menu_accounts_struct.addAction(icon_arrow_r,     "Перенести в следующий месяц")
		self.menu_accounts_struct.addSeparator()
		...
		self.menu_accounts_group_rename            : QAction = self.menu_accounts_group.addAction(icon_edit, "Переименовать")
		self.menu_accounts_group.addSeparator()
		self.menu_accounts_group_transfer_prev_dm  : QAction = self.menu_accounts_group.addAction(icon_arrow_l,     "Перенести в прошлый месяц")
		...
		self.menu_account_set_balance_initial      : QAction = self.menu_account.addAction(icon_edit,        "Установить остаток начальный")
