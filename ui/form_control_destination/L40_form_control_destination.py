...
################################################################################
## Form generated from reading UI file 'form_control_destinationebwIjA.ui'
##
...
class Ui_frm_control_destination(object):
    def setupUi(self, frm_control_destination):
        if not frm_control_destination.objectName():
            frm_control_destination.setObjectName(u"frm_control_destination")
        frm_control_destination.resize(800, 600)
        self.centralwidget = QWidget(frm_control_destination)
        ...
        frm_control_destination.setCentralWidget(self.centralwidget)
        self.statusbar = QStatusBar(frm_control_destination)
        self.statusbar.setObjectName(u"statusbar")
        frm_control_destination.setStatusBar(self.statusbar)

        self.retranslateUi(frm_control_destination)

        self.tabs_main.setCurrentIndex(1)


        QMetaObject.connectSlotsByName(frm_control_destination)
    # setupUi

    def retranslateUi(self, frm_control_destination):
        frm_control_destination.setWindowTitle(QCoreApplication.translate("frm_control_destination", u"MainWindow", None))
        self.tabs_main.setTabText(self.tabs_main.indexOf(self.tab_rules), QCoreApplication.translate("frm_control_destination", u"\u041f\u0440\u0430\u0432\u0438\u043b\u0430 \u0430\u0432\u0442\u043e\u0437\u0430\u043c\u0435\u043d\u044b \u043e\u043f\u0438\u0441\u0430\u043d\u0438\u044f", None))
        self.label_3.setText(QCoreApplication.translate("frm_control_destination", u"\u0414\u043e\u0441\u0442\u0443\u043f\u043d\u044b\u0435 \u0444\u0440\u0430\u0433\u043c\u0435\u043d\u0442\u044b", None))
        self.label.setText(QCoreApplication.translate("frm_control_destination", u"\u0424\u0440\u0430\u0433\u043c\u0435\u043d\u0442\u044b \u043f\u043e\u0438\u0441\u043a\u0430", None))
        self.label_2.setText(QCoreApplication.translate("frm_control_destination", u"\u0424\u0440\u0430\u0433\u043c\u0435\u043d\u0442 \u0437\u0430\u043c\u0435\u043d\u044b", None))
        self.btn_control_replace.setText(QCoreApplication.translate("frm_control_destination", u"\u041d\u0430\u0439\u0442\u0438 \u0438 \u0437\u0430\u043c\u0435\u043d\u0438\u0442\u044c", None))
        self.tabs_main.setTabText(self.tabs_main.indexOf(self.tab_control_replace), QCoreApplication.translate("frm_control_destination", u"\u041f\u043e\u0438\u0441\u043a \u0438 \u0437\u0430\u043c\u0435\u043d\u0430", None))
    # retranslateUi
