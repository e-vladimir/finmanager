# ФОРМА УПРАВЛЕНИЕ НАЗНАЧЕНИЕМ: МОДЕЛЬ UI

from PySide6.QtGui                import QAction, QIcon
from PySide6.QtWidgets            import QMenu

from L20_PySide6                  import C20_PySideForm
from L40_form_control_destination import Ui_frm_control_destination


class C41_FormControlDestination(C20_PySideForm, Ui_frm_control_destination):
	""" Форма Управление назначением: Модель UI """
	...
	def InitMenuRules(self):
		""" Инициализация меню правил сопоставления назначения """
		...
		self.menu_rules = QMenu("Правила сопоставления назначения")

		self.submenu_rules_rules                      = self.menu_rules.addMenu(icon_grid_2_2, "Правила сопоставления назначения")
		...
		self.submenu_rules_rule                       = self.menu_rules.addMenu(icon_grid_3_3, "Правило сопоставления назначения")
