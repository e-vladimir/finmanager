...
class C41_FormFincomposition(C20_PySideForm, Ui_frm_fincomposition):
	...
	def InitMenuFincomposition(self):
		...
		self.menu_fincomposition_reset_header  : QMenu   = self.menu_fincomposition.addMenu(icon_reload, "Сброс данных")
		self.menu_fincomposition_reset_all     : QAction = self.menu_fincomposition_reset_header.addAction(icon_reload, "Сбросить весь финсостав")
