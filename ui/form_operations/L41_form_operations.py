...
class C41_FormOperations(C20_PySideForm, Ui_frm_operations):
	...
	def Init_MenuOperations(self):
		...
		self.action_operation_open_operation           = QAction(icon_open,       "Открыть операцию")
		...
		self.action_operation_set_destination          = QAction(icon_edit,       "Редактировать назначение")
		self.action_operation_set_object_int           = QAction(icon_edit,       "Редактировать объект внутренний")
		self.action_operation_set_object_ext           = QAction(icon_edit,       "Редактировать объект внешний")
		...
		self.submenu_operation.addAction(self.action_operation_open_operation)
