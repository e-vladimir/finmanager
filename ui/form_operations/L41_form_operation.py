...
class C41_FormOperation(C20_PySideForm, Ui_form_operations):
	...
	def InitMenuOperations(self):
		...
		self.ActionEditOperationDestination = QAction(icon_list,        "Редактировать назначение")
		...
		self.SubmenuOperations.addSeparator()
		self.SubmenuOperations.addAction(self.ActionGenerateReportDm)
		self.SubmenuOperations.addSeparator()
		...
		self.SubmenuOperation.addAction(self.ActionEditOperationDestination)
		self.SubmenuOperation.addAction(self.ActionSwitchOperationSkip)
