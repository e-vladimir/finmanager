...
class C70_FormFinactions(C60_FormFinactions):
	...
	def AdjustMenuFinactionsEnable(self):
		...
		self.menu_finactions_record_edit_description.setEnabled(flag_selected_single)
	...
	def AdjustTreeData_Size(self):
		...
		sizes_min : list[int] = [100, 200]
		sizes_max : list[int] = [150, 200]
	...
	def ProcessingTreeData_DbClick(self):
		...
		match self._processing_column:
			...
			case 2: self.on_RequestEditDescriptionFinactionsRecord()
