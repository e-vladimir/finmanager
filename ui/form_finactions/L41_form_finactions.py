...
class C41_FormFinactions(C20_PySideForm, Ui_frm_finactions):
	...
	def InitMenuFinstruct(self):
		...
		icon_arrow_l_r  = QIcon("./L0/icons/arrow_left_right.svg")
		...
		self.menu_finactions_rules_header         : QMenu   = self.menu_finactions.addMenu(icon_processing, "Правила обработки данных")
		self.menu_finactions_rules_apply          : QAction = self.menu_finactions_rules_header.addAction(icon_replace, "Применить к выбранному")
		self.menu_finactions_rules_apply_global   : QAction = self.menu_finactions_rules_header.addAction(icon_replace, "Применить глобально")
