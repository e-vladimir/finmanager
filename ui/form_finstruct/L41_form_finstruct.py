...
class C41_FormFinstruct(C20_PySideForm, Ui_form_finstruct):
	...
	def InitMenuFinstruct(self):
		...
		self.menu_finstruct_copy_prev_dm              : QAction = self.menu_finstruct_header.addAction(icon_arrow_l_2, "Перенести все счета в предыдущий месяц")
		self.menu_finstruct_copy_next_dm              : QAction = self.menu_finstruct_header.addAction(icon_arrow_r_2, "Перенести все счета в следующий месяц")
		...
		self.menu_finstruct_group_copy_prev_dm        : QAction = self.menu_finstruct_group_header.addAction(icon_arrow_l_2, "Перенести группу счетов в предыдущий месяц")
		self.menu_finstruct_group_copy_next_dm        : QAction = self.menu_finstruct_group_header.addAction(icon_arrow_r_2, "Перенести группу счетов в следующий месяц")
