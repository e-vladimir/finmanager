...
class C90_FormReset(C80_FormReset):
	...
	def on_RequestProcessingReset(self):
		...
		self.ReadIdosFinstruct()
		self.ReadIdosFinactions()
		self.ReadIdosFindescription()
		self.ReadIdosFindescriptionInFinactions()
		self.ReadIdosFinstate()
		self.ReadIdosFindata()
		self.ReadIdosRules()
